<div class="row gx-0">
  ...
  <div class="col-6">
    <div class="m-2">
      <div id="detail-role" class="border rounded bg-white p-3 mb-2"><em>Please select a role from the list to show its detailed information.</em></div>
      <div class="border rounded bg-white p-3">
        <h4><span class="module-name text-primary"></span></h4>
        <div id="list-function"></div>
      </div>
    </div>
  </div>
</div>
