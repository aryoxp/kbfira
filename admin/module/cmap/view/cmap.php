<div class="app-navbar d-flex p-2 border-bottom">
  ...
  <div class="btn-group btn-group-sm ms-2">
    ...
    <button class="bt-export btn btn-primary"><i class="bi bi-send"></i> <?php echo Lang::l("cmap-export"); ?></button>
  </div>
  <div class="btn-group btn-group-sm ms-2">
    <button class="bt-assign-topic btn btn-primary"><i class="bi bi-lightbulb"></i> <?php echo Lang::l("cmap-assign-topic"); ?></button>
    <button class="bt-assign-text btn btn-primary"><i class="bi bi-file-earmark-font"></i> <?php echo Lang::l("cmap-assign-text"); ?></button>
  </div>
</div>
...
<form id="concept-map-save-as-dialog" class="card d-none">
  ...
  <div class="card-body">
      ...
      <div class="row mb-1 align-items-center">
        <label for="input-fid" class="col-sm-3 col-form-label"><?php echo Lang::l("cmap-custom-id-opt"); ?></label>
        <div class="col-sm-9">
...
<form id="concept-map-open-dialog" class="card d-none">
  <h6 class="card-header"><i class="bi bi-folder2-open"></i> <?php echo Lang::l("cmap-open-cmap"); ?></h6>
  <div class="card-body">
    <ul class="nav nav-pills" id="open-concept-map-tab" role="tablist">
      <li class="nav-item" role="presentation">
        <button class="nav-link px-2 py-1 active" id="home-tab" data-bs-toggle="tab" data-bs-target="#database" type="button" role="tab" aria-controls="home" aria-selected="true"><small><?php echo Lang::l("cmap-db"); ?></small></button>
      </li>
      <li class="nav-item" role="presentation">
        <button class="nav-link px-2 py-1" id="profile-tab" data-bs-toggle="tab" data-bs-target="#decode" type="button" role="tab" aria-controls="profile" aria-selected="false"><small><?php echo Lang::l("cmap-decode"); ?></small></button>
      </li>
    </ul>
    <hr class="my-2">
      ...
      <div class="tab-pane fade show active" id="database" role="tabpanel" aria-labelledby="database-tab">
        <div class="row gx-2 mb-1">
          <div class="col d-flex">
            <span class="border-bottom px-2 py-1 flex-fill position-relative"><?php echo Lang::l("cmap-topic"); ?></span></div>
          <div class="col d-flex">
            <span class="border-bottom px-2 py-1 flex-fill position-relative"><?php echo Lang::l("cmap-cmap"); ?></span></div>
        </div>
        <div class="row gx-2 mb-3">
          <div class="col list list-topic">
            <span class="topic list-item default" data-tid="">
              <em><?php echo Lang::l("cmap-unassigned"); ?></em><bi class="bi bi-check-lg text-primary"></bi>
            </span>
          </div>
          <div class="col list list-concept-map"></div>
        </div>
        <div class="badge rounded-pill bg-secondary bt-refresh-topic-list" role="button"><?php echo Lang::l("cmap-refresh-topic-list"); ?></div>
      </div>
      <div class="tab-pane fade" id="decode" role="tabpanel" aria-labelledby="decode-tab">
        <div class="mb-3">
          <label for="decode-textarea" class="form-label"><?php echo Lang::l("cmap-cmap-data"); ?></label>
...
<div id="concept-map-export-dialog" class="card d-none">
  <h6 class="card-header"><i class="bi bi-send"></i> <?php echo Lang::l("cmap-export"); ?></h6>
  <div class="card-body">
  ...
  <div class="card-footer text-end">
    ...
    <button class="btn btn-sm btn-primary ms-1 bt-clipboard px-3"><i class="bi bi-clipboard"></i> <?php echo Lang::l("cmap-copy-to-clipboard"); ?></button>
  </div>
</div>
