<div class="card mx-5 my-3">
  <div class="card-body">
    <h3 class="card-title mb-5">Kit-Build Runtime Configuration<br><small class="h5"><code>admin/module/kitbuild/runtime/config.ini</code></small></h3>
    <div class="row">
      <div class="col-md-6 col-sm-12">
        <label for="input-kitbuild-app-runtime-path" class="form-label">App runtime path:</label>
        <div class="input-group">
          <input type="text" class="form-control" id="input-kitbuild-app-runtime-path" value="kitbuild/runtime/config.ini">
