<div class="d-flex flex-column vh-100">
  ...
  <div class="app-navbar d-flex p-2 ps-4" style="border-left: 125px solid #777;">
...
<div id="register-dialog" class="card d-none">

  <div class="card-body mx-3 text-center">
    <form name="form-register" autocomplete="off">
    <h1 class="h3 mb-4 mt-4 fw-normal">Please register</h1>
    <div class="form-floating">
      <input type="text" class="form-control rounded-0 rounded-top" id="input-name" placeholder="Name" autocomplete="new-password" style="margin-bottom: -1px;">
      <label for="input-name">Name</label>
    </div>
    <button class="w-100 btn btn-lg btn-primary bt-register" type="submit">Register</button>
    <hr class="mt-4">
    By registering, a random new username will be created. All associated data to this username will be removed after several days.
